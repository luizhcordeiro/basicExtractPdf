"""
conta 3 e 4 funcionais

1: Aumentei um pedaço além do bbox de 3 para pegar "o total box"

2: resolvendo quando valores são "" e precisam virar INT ou FLOAT:

Inicialmente mudei apenas a função transform_number(x) de:
...
obs: erros de Array ignorados pq ela é apenas um teste, ficará para o fim
...
pdf = pdfquery.PDFQuery("contas/light_modelo_5_4.pdf")
pdf.load()
...
header_information = pdf.extract([
    ...
    ("document", 'LTTextLineHorizontal:in_bbox("40, 667.001, 200, 675.093")'),
    ("conta_contrato", 'LTTextLineHorizontal:in_bbox("40, 657.651, 200, 665.743")'),
